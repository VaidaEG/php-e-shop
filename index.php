                ...
                <div class="owl-carousel owl-theme">
                    <div class="item">
                        <div class="card border-0 font-rale me-5" style="width: 18rem;">
                            ...
                            <p class="card-text font-size-14 text-black-50 py-1">Lorem ipsum dolor sit amet consectetur adipisicing elit. Illo sunt, officia iusto ea magni sint eveniet sed cumque nostrum suscipit.</p>
                            <a href="#" class="text-decoration-none color-second text-left">Go somewhere</a>
                        </div>
                    </div>
                    <div class="item">
                        <div class="card border-0 font-rale me-5" style="width: 18rem;">
