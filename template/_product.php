...
<section class="product" class="py-3">
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-6 py-5">
                ...
                <table class="my-3">
                    <tr class="font-rale font-size-14">
                        <td>M.R.P.:</td>
                        <td><strike>162.00 Eur</strike></td>
                    </tr>
                    <tr class="font-rale font-size-14">
                        <td>Deal Price:</td>
                        <td class="font-size-20 text-danger"><span>152.00</span>&nbsp;Eur<small class="text-dark font-size-12">&nbsp;&nbsp;Inclusive of all taxes</small></td>
                    </tr>
                    <tr class="font-rale font-size-14">
                        <td>You save:</td>
                        <td><span class="font-size-16 text-danger">10.00 Eur</td>
                    </tr>
                </table>
                <!-- !product price -->
                <!-- #policy -->
            ...
            <div class="col-12">
                <h6 class="font-rubik my-3">Product Descriprion</h6>
                <hr>
                <p class="font-rale font-size-14">Lorem ipsum dolor sit amet consectetur adipisicing elit. Mollitia cumque aut corrupti. Ratione minima laboriosam rerum, earum possimus quasi totam? Veritatis dolorem aliquid aperiam optio id velit, earum sunt nobis ab modi maiores autem ipsa vel, porro doloribus veniam nemo ea quam eos officia? Quasi consequuntur sint rerum vel. Assumenda?</p>
                <p class="font-rale font-size-14">Lorem ipsum dolor sit amet consectetur adipisicing elit. Mollitia cumque aut corrupti. Ratione minima laboriosam rerum, earum possimus quasi totam? Veritatis dolorem aliquid aperiam optio id velit, earum sunt nobis ab modi maiores autem ipsa vel, porro doloribus veniam nemo ea quam eos officia? Quasi consequuntur sint rerum vel. Assumenda?</p>
            </div>
        </div>
    </div>
